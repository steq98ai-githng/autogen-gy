...
**Action:** Whenever verifying or modifying popup modals, full-screen overrides, or expanded content panes, manually inspect all internal icon-only buttons (like X/Close, maximize, minimize) to guarantee they possess `focus:outline-none focus-visible:ring-2 focus-visible:ring-accent`.
