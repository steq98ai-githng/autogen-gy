      ...
      >
        ...
        >
          ...
          <textarea
            ...
            className={`flex items-center w-full resize-none text-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-accent ${
              dragOver
            ...
            >
              ...
              <Upload className="zero-padding-upload  " {...uploadProps}>
                <Tooltip
                  ...
                  placement="top"
                >
                  <Button type="text" disabled={isInputDisabled} className=" " aria-label="Upload File">
                    <UploadIcon
                      strokeWidth={2}
                      size={26}
